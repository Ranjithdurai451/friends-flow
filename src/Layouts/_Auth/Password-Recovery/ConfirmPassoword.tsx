...
import { ConfirmPasswordType } from '../../../functions/types/types';
import { ConfirmPassowordSchema } from '../../../functions/Schema';

const ConfirmPassoword = () => {
  const {
    register,
    formState: { errors, isSubmitting, isDirty, isValid },
    handleSubmit,
  } = useForm<ConfirmPasswordType>({
    resolver: zodResolver(ConfirmPassowordSchema),
  });
  ...
  async function submitHandler({
    ...
    try {
      if (newPassword && RepeatednewPassword) {
        var promise = await account.updateRecovery(
          userID,
          secret,
          newPassword,
          RepeatednewPassword
...
export default ConfirmPassoword;
