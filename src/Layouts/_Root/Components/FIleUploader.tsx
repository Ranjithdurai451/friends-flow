...
const FileUploader = ({ fieldChange, mediaUrl }: FileUploaderProps) => {
  ...
  return (
    <div {...getRootProps()}>
      <input {...getInputProps()} />
      {url ? (
        <div className="flex flex-col px-3 justify-center items-center gap-3 bg-white bg-opacity-10">
          <img
            src={url}
          ...
          <button
            type="button"
            className="py-3 px-5 rounded bg-white bg-opacity-10"
          >
        ...
        <div className="rounded-lg bg-white bg-opacity-10 flex flex-col justify-center items-center h-[300px] gap-3">
          ...
          <h2 className="text-white text-xl">Drag photo here</h2>
