...
function ExploreIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M16.221 10.794c1.662 0 3.015-1.352 3.015-3.015s-1.352-3.015-3.015-3.015c-1.662 0-3.015 1.352-3.015 3.015s1.352 3.015 3.015 3.015zm0-4.823c.997 0 1.809.811 1.809 1.809s-.811 1.809-1.809 1.809-1.809-.811-1.809-1.809.811-1.809 1.809-1.809z"></path>
    </svg>
  );
}
